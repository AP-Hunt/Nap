...
class Stub_ParamScheme_SingleRequiredParam extends Stub_ParamScheme_SingleParam
{
    ...
    {
        parent::__construct(new Stub_Param("id", true, "\d+", "id")); // TODO: Change the autogenerated stub
    }
...
class Stub_ParamScheme_SingleOptionalParam extends Stub_ParamScheme_SingleParam
{
    public function __construct()
    {
        parent::__construct(new Stub_Param("id", false, "\d+", "id")); // TODO: Change the autogenerated stub
    }
}
...
class Stub_ParamScheme_SingleIntParam extends Stub_ParamScheme_SingleParam
{
    ...
    {
        parent::__construct(new Stub_IntParam("id", true, "\d+", $identifier)); // TODO: Change the autogenerated stub
    }
}